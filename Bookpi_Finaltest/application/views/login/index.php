...
<body class="">
  ...
  <div class="container ">
  <div class="container bg-gradient-primary rounded">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form method="POST" class="user" action="<?php echo base_url('acc/login');?>">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_error('pass','<div class="text-danger small">','</div>');?>
                    </div>
                    <button type="submit" class="btn btn-primary form-control">Login</button>
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url('acc/regis');?>">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
